...
import { toggleMovieForUser } from "../data/action/serversubmit";
...
function MovieLoveCard(props: { movie: any }) {
  ...
  const email: string | null | undefined = session?.user?.email; // เปลี่ยนเป็นอีเมลจริง
  // console.log(session);
      ...
      <div
        ...
        onClick={async() => {
          if (email !== null && email !== undefined) {
            await toggleMovieForUser(email, movie.id);
            setlove(!love);
          }
        }}
      >
